        ...
        <div className=" rounded-xl w-96 h-96 bg-slate-500 text-center">
            ...
            <form action="get">
                <div className="flex justify-center gap-4 mb-8 bg-slate-100 mx-10 py-2 rounded-xl">
                    <Mail size={40}/>
                    <input className="bg-transparent border-0 border-none focus:outline-none text-gray-950" type="email" placeholder="Email"/>
                </div>
                <div className="flex justify-center gap-4 mb-8 bg-slate-100 mx-10 py-2 rounded-xl">
                    <LockKeyhole size={40}/>
                    <input className="bg-transparent border-0 border-none focus:outline-none text-gray-950" type="password" placeholder="Password"/>
                </div>
