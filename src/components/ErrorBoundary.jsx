        ...
        <section className="bg-primary">
            <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
                <div className="flex flex-col items-center max-w-sm mx-auto text-center">
                    <p className="p-3 text-sm font-medium text-blue-500 rounded-full bg-primary ">
                        <svg
                    ...
                    <h1 className="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl min-w-full">
                    ...
                    <div className="flex items-center justify-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                        ...
                        <Link to={"/"}>
                            <button className="px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                                Take me home
                            </button>
                        </Link>
                    </div>
